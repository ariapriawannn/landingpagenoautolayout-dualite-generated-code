...
const App = () => {
  return (
    <div className="parent-div ">
      <div className="landing-page-no-23 pos-abs">
        {/* Frame 100000462422 */}
        <section className="frame-100000462-24 pos-abs">
          <div className="logo-25 pos-abs">
            <div className="logo-26 pos-abs">
              <div className="logo-1-29269 pos-abs">
                <img
                  src="https://s3-alpha-sig.figma.com/img/8429/da15/e5744182e60975573027bd31952f6da8?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=aZOcrRQM~d-q-RNV6IerT~xE5PMffJ~P~kVDrqTFHv5jpO5TPVfzCiGByuWOUiBk6XDTl2lURj6GchiaaQCrn41eH4JoOBgk4JwB12d-otFmMBSlU4pXTtagM8LJgsj8yGWi2QdjSSQWaaozE2D9umnbyyqb6OD39r9fbPW-6CAeQoXWUSrX-6YW4mL7iVZeuM9y3tv~xLA1XlKvWpUWFL8PkIHX83B~ahdZyFEyYlvirqVRh7pbdJgIZPTXH0GWzVWhoR5N-npq5iL~WkMf3rVPhX-evy~hsRnBDxs7RYT5fjQKEJ1nBCVCgRK2elln6edt8GI2M3RouMg80ieuUQ__"
                  className="pos-abs image-div bg-no-repeat bg-crop nodeBg-29269 "
                  alt="29269-ALT"
                />{" "}
              </div>
            </div>

            <div className="raih-peduli-1-29265 pos-abs">
              <img
                src="https://s3-alpha-sig.figma.com/img/a548/f822/48feeea309297b5f373573b5220f9c96?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=sJa1er6kHSu0Oi-TcOlknzJqRhnU6l~F9Xm1~MqafCSDC6xvn5aelQIN6N3X6wYAPVU3ifoOq4co9gtvnZe2dTEGWNxSB~TOxMGkrO2Wyg4YwqiBNfLK6ds8Xigg~-GCQwU4s3vhK7gbEVliMvWC8Hq~lh98UpMULALRW1MRcuLlnGNHfnK5r7XDMw1ZX-PV3f9U-fNXX2DQmAW9u8ObRdpQjUiYz8SoJydjUPYdJl-ZENhRRVu-TehxURQzXwQvI8Q6e3XLQXAws0jYyJ6i-706qv9Vh84i~44-kRaOr1aoX64swxXXis5yCELISS9LXqnHL8AjwLbcYxiNc-U-8Q__"
                className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29265 "
                alt="29265-ALT"
              />{" "}
            </div>
          </div>

          <div className="frame-4-220 pos-abs">
            <div className="tentang-kami-221 pos-abs">
              <span className="tentang-kami-221-0">{`TENTANG KAMI`}</span>
            </div>

            <div className="donasi-222 pos-abs">
              <span className="donasi-222-0">{`DONASI`}</span>
            </div>

            <div className="relawan-223 pos-abs">
              <span className="relawan-223-0">{`RELAWAN`}</span>
            </div>

            <div className="berita-224 pos-abs">
              <span className="berita-224-0">{`BERITA`}</span>
            </div>

            <div className="mitra-225 pos-abs">
              <span className="mitra-225-0">{`MITRA`}</span>
            </div>
          </div>

          <div className="btnmasuk-226 pos-abs">
            <div className="btn-227 pos-abs">
              <div className="masuk-228 pos-abs">
                <span className="masuk-228-0">{`Masuk`}</span>
              </div>
            </div>
          </div>
        </section>
        {/* Banner1 */}
        <section className="banner-28563 pos-abs">
          <div className="pixabay3108155-28565 pos-abs">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/figma-plugin-a7287.appspot.com/o/user-images%2F15-jun-2025%2Fariapriawan yahya1750006456346%2Fimage-285-65.png?alt=media&token=0"
              className="pos-abs pos-init fill-parent bg-contain bg-no-repeat image-div  object-fit"
              alt="28565-ALT"
            />{" "}
          </div>

          <div className="supporting-text-28567 pos-abs">
            <span className="supporting-text-28567-0">{`Wujudkan Niat Baikmu`}</span>
          </div>
        </section>
        {/* Frame 100000462421 */}
        <section className="frame-100000462-231 pos-abs">
          <div className="frame-100000462-232 pos-abs">
            <div className="frame-100000462-234 pos-abs">
              <div className="c-2000-235 pos-abs">
                <span className="c-2000-235-0">{`2.000`}</span>
              </div>

              <div className="relawan-236 pos-abs">
                <span className="relawan-236-0">{`Relawan`}</span>
              </div>
            </div>

            <div className="vector-233 pos-abs">
              <div className="nodeBg-233 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
            </div>
          </div>

          <div className="frame-100000462-237 pos-abs">
            <div className="frame-100000462-239 pos-abs">
              <div className="c-300-240 pos-abs">
                <span className="c-300-240-0">{`300`}</span>
              </div>

              <div className="mitra-241 pos-abs">
                <span className="mitra-241-0">{`Mitra`}</span>
              </div>
            </div>

            <div className="vector-12927 pos-abs">
              <div className="nodeBg-12927 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
            </div>
          </div>

          <div className="frame-100000462-242 pos-abs">
            <div className="frame-100000462-244 pos-abs">
              <div className="c-1500-245 pos-abs">
                <span className="c-1500-245-0">{`1.500`}</span>
              </div>

              <div className="kegiatan-246 pos-abs">
                <span className="kegiatan-246-0">{`Kegiatan`}</span>
              </div>
            </div>

            <div className="vector-243 pos-abs">
              <div className="nodeBg-243 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
            </div>
          </div>
        </section>
        {/* Frame 100000462423 */}
        <section className="frame-100000462-247 pos-abs">
          <div className="frame-100000462-248 pos-abs">
            <div className="frame-100000462-2262 pos-abs">
              <div className="tentang-kami-2263 pos-abs">
                <span className="tentang-kami-2263-0">{`Tentang Kami`}</span>
              </div>

              <div className="kami-adalah-kom-2264 pos-abs">
                <span className="kami-adalah-kom-2264-0">{`Kami adalah komunitas yang tumbuh dengan semangat untuk memberdayakan perubahan positif. Di Raih Peduli, kami percaya bahwa kepedulian adalah kunci untuk meraih masyarakat yang lebih baik. Sejak awal, misi kami adalah menyinari dunia dengan aksi sosial yang bermakna. Setiap langkah yang kami ambil, setiap donasi yang kami terima, dan setiap sukarelawan yang bergabung membentuk fondasi kami untuk meraih lebih banyak lagi. Bersama, mari kita wujudkan dampak yang berarti dan raih kebaikan bersama Raih Peduli.`}</span>
              </div>
            </div>

            <div className="frame-100000462-249 pos-abs">
              <div className="container-250 pos-abs">
                ...
                <div className="button-2247 pos-abs">
                  <div className="container-2248 pos-abs">
                  ...
                  <div className="raih-peduli-2261 pos-abs">
                    <span className="raih-peduli-2261-0">{`Raih `}</span>
                    <span className="raih-peduli-2261-1">{`Peduli`}</span>
                  </div>
                </div>
                ...
                <div className="switch-2188 pos-abs">
                  <div className="vector-13560 pos-abs">
                    <div className="nodeBg-13560 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
                  </div>
                </div>
        ...
        {/* Frame 100000462431 */}
        <section className="frame-100000462-2265 pos-abs">
          <div className="frame-100000462-2266 pos-abs">
            <div className="frame-100000462-2267 pos-abs">
              <div className="heading-2268 pos-abs">
                <span className="heading-2268-0">{`Kami Ada untuk Anda`}</span>
              </div>

              <div className="supporting-text-2269 pos-abs">
                <span className="supporting-text-2269-0">{`Kenyamanan, kemudahan dan keamanan anda adalah prioritas utama kami. Apa yang dapat anda lakukan di platform kami?`}</span>
              </div>

              <div className="title-2273 pos-abs">
                <span className="title-2273-0">{`User dapat berdonasi menggunakan beberapa Metode Pembayaran`}</span>
              </div>

              <div className="vector-2272 pos-abs">
                <div className="nodeBg-2272 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
              </div>

              <div className="title-2276 pos-abs">
                <span className="title-2276-0">{`User juga dapat mengajukan Program Penggalangan Dana`}</span>
              </div>

              <div className="vector-2275 pos-abs">
                <div className="nodeBg-2275 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
              </div>

              <div className="supporting-text-2277 pos-abs">
                <span className="supporting-text-2277-0">{`Raih Peduli memungkinkan Anda untuk terlibat dalam donasi dengan cara yang mudah dan aman serta dapat berkontribusi langsing dalam kegiatan sosial. Kami berkomitmen untuk menyediakan sarana yang memungkinkan Anda berperan dalam perubahan yang diinginkan.`}</span>
              </div>
            </div>

            <div className="frame-100000462-2278 pos-abs">
              <div className="container-2279 pos-abs">
        ...
        {/* Frame 100000462461 */}
        <section className="frame-100000462-2444 pos-abs">
          <div className="container-2445 pos-abs">
            <div className="checkbox-2446 pos-abs">
              <div className="img-2447 pos-abs">
                ...
                <div className="img-2756 pos-abs">
                ...
                <div className="tooltip-2545 pos-abs">
                  ...
                  <div className="donations-2584 pos-abs">
                    <span className="donations-2584-0">{`DON`}</span>
                    <span className="donations-2584-1">{`ATIONS`}</span>
                  </div>
                </div>
            ...
            <div className="paragraph-conta-2861 pos-abs">
              <div className="heading-2862 pos-abs">
                <span className="heading-2862-0">{`Apa Itu 
Penggalangan dana?`}</span>
              </div>

              <div className="supporting-text-2863 pos-abs">
                <span className="supporting-text-2863-0">{`Penggalangan Dana fitur yang bertujuan untuk mengumpulkan sumbangan dana, barang, atau bantuan finansial untuk mendukung sebuah tujuan atau inisiatif tertentu. Ini memungkinkan anda untuk bersatu dalam memberikan kontribusi dalam rangka membantu berbagai program kemanusiaan atau sosial.`}</span>
              </div>
            </div>
          </div>
        </section>
        {/* Frame 100000462481 */}
        <section className="frame-100000462-2864 pos-abs">
          <div className="frame-100000462-2865 pos-abs">
            <div className="heading-2866 pos-abs">
              <span className="heading-2866-0">{`Bagaimana Lowongan 
Relawan Bekerja?`}</span>
            </div>

            <div className="supporting-text-2867 pos-abs">
              <span className="supporting-text-2867-0">{`Lowongan relawan memberikan kesempatan bagi anda untuk berpartisipasi secara langsung dalam kegiatan-kegiatan sosial seperti peduli lingkungan, pendidikan, kesehatan, dll. Apa yang dapat anda lakukan di platform kami?`}</span>
            </div>

            <div className="title-2871 pos-abs">
              <span className="title-2871-0">{`User dapat mendaftar sebagai Relawan Sosial`}</span>
            </div>

            <div className="vector-2870 pos-abs">
              <div className="nodeBg-2870 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
            </div>

            <div className="title-2874 pos-abs">
              <span className="title-2874-0">{`User juga dapat mengajukan Program Lowongan Relawan`}</span>
            </div>

            <div className="vector-2873 pos-abs">
              <div className="nodeBg-2873 pos-abs pos-init fill-parent image-div bg-contain bg-no-repeat "></div>
            </div>

            <div className="supporting-text-2875 pos-abs">
              <span className="supporting-text-2875-0">{`Mari terlibat secara sukarela dalam berbagai program atau kegiatan sosial guna memberikan kontribusi positif bagi sekitar. `}</span>
            </div>
          </div>

          <div className="frame-100000462-2876 pos-abs">
            <div className="rating-containe-2877 pos-abs">
        ...
        {/* Frame 100000462441 */}
        <section className="frame-100000462-21172 pos-abs">
          <div className="frame-100000462-21173 pos-abs">
          ...
          <div className="frame-100000462-21288 pos-abs">
            <div className="berita-21289 pos-abs">
              <span className="berita-21289-0">{`Berita`}</span>
            </div>

            <div className="supporting-text-21290 pos-abs">
              <span className="supporting-text-21290-0">{`Raih Peduli menyajikan berbagai infromasi sosial terkini yang terjadi di sekitar kita, baik secara lokal, nasional, maupun internasional. `}</span>
            </div>

            <div className="supporting-text-21291 pos-abs">
              <span className="supporting-text-21291-0">{`Di sini, kami berkomitmen untuk menyajikan berita yang akurat, informatif, dan relevan. Kami menyediakan informasi terkini dalam berbagai topik sosial seperti bencana alam, kesehatan, pendidikan, dan berbagai macam sajian berita lainnya.`}</span>
            </div>
          </div>
        </section>
        {/* Frame 100000462424 */}
        <section className="frame-100000462-21292 pos-abs">
          <div className="frame-100000462-21293 pos-abs">
            <div className="heading-21294 pos-abs">
              <span className="heading-21294-0">{`Mitra Kami`}</span>
            </div>

            <div className="supporting-text-21295 pos-abs">
              <span className="supporting-text-21295-0">{`Kami bekerjasama dengan berbagai organisasi dan komunitas dalam mengelola Raih Peduli.`}</span>
            </div>
          </div>

          <div className="frame-100000462-21296 pos-abs">
            <div className="frame-100000462-21297 pos-abs">
              <div className="image-21298 pos-abs">
                <img
                  src="https://s3-alpha-sig.figma.com/img/2c3b/bc4d/ddec60577c26e1e99b0c1746bb150de0?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Ngv99xXXbTUEHH-3YbnoA8qJwBLftxkNEH~UQZ7t8N04v1YdubeeLDS31jnqq7lXzND6Zh8572a-lW9KZAbB3INQgZqGKXVSWev4W-91PbqujvxeigN1IBLzTZY8OG9QZKGwwwRR~RXEmM~9hwXTZuS7jOBPMdokAoUvmQpI2Kk~coSKrrzimuQZsFQ2~TuSFCnytqehOa0oh5g1umk0fWyipgmZUh0dgln00FBwj2cIwMErDDu6jfeY5rNeSD1gepnuhRhd9rs6KZ3Ps4uNuI2yEUq6gcS03Rbnjo2dd4YpM3I~5LmNUbJCCc0C8m7U1Q0yAPnxOIWJWzIukQacJw__"
                  className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-21298 "
                  alt="21298-ALT"
                />{" "}
              </div>

              <div className="image-21299 pos-abs">
                <img
                  src="https://s3-alpha-sig.figma.com/img/25c8/f001/62fe42fd8870e3cde65073b70fbf42ce?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=mkkPNKeOHRDMWxsPE7alZLHHCKKumiTxpam7qRdjwVSKrgMXRdjPK-iAgTekYHy7HgjDiBLxvw2EngQiv6K6QdH9dZzQsB9tdnfdNibm6BZdX~yxVhDNuTTPHI1iOe4LqSjYjPPPZeScK8y2BYnLnhZ3HPsoHhmN8SL7P49o6mmLt3gGfxxYAIxXpsPgUUysVwSAJXbtR-lz2MhusCopcrJ4mlorSVKS9~A-~T~dc68FNuhhXp8p7c~jLIbqs0lCdArA8gZHsif8Lww~KIApAUBBBvqf6IP6O9vXIGG4c4GzH74DC953x~PdOyEMkeGgrh1ivNJS8C~cNGKwp8U7aA__"
                  className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-21299 "
                  alt="21299-ALT"
                />{" "}
              </div>

              <div className="image-21300 pos-abs">
                <img
                  src="https://s3-alpha-sig.figma.com/img/eec5/a938/117ff339cd1f41d2cc6b57cd1d70397f?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=X333E-p5~QVrv3iK-XZwJzA~AYEoHsDJnYFZTskEVReeoAIV~-POa63bI7UouieR7p3sMhXceQbinjO4cECLD8fyUfesGETYqjo9rJBNsqWoxrcOt~vVQoikyfQ0PVcYKOt5CD2oenieAYG1I7rJ6TYevr-h0swV71HgIyP4IMvlQclz2oi97cZUWTsaWIPPtrSeoI-Hg4EvYrFKxZLu-nkuKzvzQtmfOd5hzxhmGYaj05UOiXQaPyWj0ntwd8gCQuFf0PVqfVw1zZ~-43K~PsLg6hTqsRieenp7c8fwervCzO50ZLDUOtfOxLN8~JB7ouWRi1cf4n4zD3EUV~uGTw__"
                  className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-21300 "
                  alt="21300-ALT"
                />{" "}
              </div>

              <div className="image-21301 pos-abs">
                <img
                  src="https://s3-alpha-sig.figma.com/img/fb19/f6df/b778ff5ae77ec625b7181fb0794b790d?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=TzqFtI-UD7gL1TIUF2b1Oy~QBrjqk6KspldK2rdDr95BVQj~VK-JaEUui2l9fu5X27VE2TctS8-q5hj2wtxoZolzsP-r3S6suVO4pmfCO4jT-6MW3Y58bgquiYAGkmeUXy4LaG7OwhhHZulm6ZSq2FIjCCQo3sPwDnTEM35BHpH4sosHEEhmFIHpdmyCBdDGnxLkW13oqM6YrelXUk4ecKy9SHH9AaAveQsVOyorYAiueGMt4zNaQ2xEk36zrvmqAgtfvFLylBgrXVSx6Hm0bI6FBWK3vaI9hDp6TJtlb5Yt4bmCAsEAx-MyyUR7RYnjGATdk2tSfL1BP4pSS6t07w__"
            ...
            <div className="frame-100000437-1212918 pos-abs">
              <div className="button-21302 pos-abs">
                <div className="image-21303 pos-abs">
                  <img
                    src="https://s3-alpha-sig.figma.com/img/c82d/1058/90ddd015920b512024814338beeefeb8?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=N7ltzpy5wfYfN3Z~~LtUT-dSF6BKODbjvkE0lKlfqL0sPcug52okK6HVK-9Aw-r4b0kuNATWEzEWYPZ3mZ2un4lspGURK5pTdgQWZsKmHe8ti7SfHgkRg5iTNvrUxmd6E1dH4DymG-B0IZg1iJlQcfPXBTwN0qgiYcC1EtgOHop~piB9AuYuS-MoKQ6jes3ZfKkPFjjRbNE-R4MJDD6nUMROPl0YG9hgEqt0Epd2HkDCeujwJbqyJfA9qCfpSPXafDf-24VaLyj2z5l4gAkC~dAyCpv9m5HdBIHWStmwIx66Bo8Zq9NZtrxdfevj61eqeHfhvWdHuVjVw9SA4~Lm5g__"
                    className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-21303 "
                    alt="21303-ALT"
                  />{" "}
                </div>

                <div className="image-21304 pos-abs">
                  <img
                    src="https://s3-alpha-sig.figma.com/img/9cf3/e7ec/9876ec699b5a458d18abb260bfdbf1d7?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=WS1lPEMMitJv2hpSVoFprxvzpNAol60wVFyMFWoR1eBlw1i8BY5I0G41uubtK1iO7WvW9P5TmAIFmJwnEUW9EGk9htOQS3OHL3uVJwRCTTAgHjVlx4iWckC5A6nvGtAjxSmdvkQwWubW5q3hRLb528VAkazCog1B5mePI70gX00z2Dt0-uORKnIYxyUNGkRDDmbekxkKbZnnwsKVJoUqUt5nR694ilz7SgvyOrgUA~vNkBwYZBnQsUTXUU3vkwhwZnzm0fHBK5WEZXdaUp-AL07-aIjbqqwcugxPhsnuh1hLxoxLYCFuKZHeDI-4gfjpy5c5tLHu8nwZ4a3VhAnF3w__"
                    className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-21304 "
                    alt="21304-ALT"
                  />{" "}
                </div>

                <div className="image-21305 pos-abs">
                  <img
                    src="https://s3-alpha-sig.figma.com/img/37e8/11bc/59ea662a3207c8fb741a8222289d63c3?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=n-SNn8FVEGu3ZVRUbHtFbwVdy6CS0M75k2aMxXWqITxCrfFR05JN6yewenzBE4R3NDjh03C-G4AyfwJTqwxhCcRbDV6UwnJ81uBx1oLTHnHTDmySQByvY5~ZiwO5FlIpgKhaRldOQnGJ2ZfIfLBO5OJT7D70uQ~d4gB7FyS1d5kZpgctyjOCCiddaj-sv~b~iiNko6sth51zNsEyFMvO3-N9MPSY9q2G8c6JNneuBxl1-wbI34I3DlSAzUyC8XqGybupIBZZ6lS2yL2vV40TVsdK3HZXqT8duy2ozVZpHX~vz4j5LqIICYSDZ9QvQwKqRQnH4u48e8O8cLREm5SB2Q__"
        ...
        {/* Frame 100000462451 */}
        <section className="frame-100000462-21306 pos-abs">
          <div className="frame-100000462-21307 pos-abs">
            <div className="frame-100000462-21308 pos-abs">
              <div className="frame-100000462-21309 pos-abs">
                <div className="button-21310 pos-abs">
                  <div className="container-21311 pos-abs">
                    <div className="logo-1-29271 pos-abs">
                      <img
                        src="https://s3-alpha-sig.figma.com/img/8429/da15/e5744182e60975573027bd31952f6da8?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=aZOcrRQM~d-q-RNV6IerT~xE5PMffJ~P~kVDrqTFHv5jpO5TPVfzCiGByuWOUiBk6XDTl2lURj6GchiaaQCrn41eH4JoOBgk4JwB12d-otFmMBSlU4pXTtagM8LJgsj8yGWi2QdjSSQWaaozE2D9umnbyyqb6OD39r9fbPW-6CAeQoXWUSrX-6YW4mL7iVZeuM9y3tv~xLA1XlKvWpUWFL8PkIHX83B~ahdZyFEyYlvirqVRh7pbdJgIZPTXH0GWzVWhoR5N-npq5iL~WkMf3rVPhX-evy~hsRnBDxs7RYT5fjQKEJ1nBCVCgRK2elln6edt8GI2M3RouMg80ieuUQ__"
                        className="pos-abs image-div bg-no-repeat bg-crop nodeBg-29271 "
                        alt="29271-ALT"
                      />{" "}
                    </div>
                  </div>

                  <div className="raih-peduli-1-29263 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/a548/f822/48feeea309297b5f373573b5220f9c96?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=sJa1er6kHSu0Oi-TcOlknzJqRhnU6l~F9Xm1~MqafCSDC6xvn5aelQIN6N3X6wYAPVU3ifoOq4co9gtvnZe2dTEGWNxSB~TOxMGkrO2Wyg4YwqiBNfLK6ds8Xigg~-GCQwU4s3vhK7gbEVliMvWC8Hq~lh98UpMULALRW1MRcuLlnGNHfnK5r7XDMw1ZX-PV3f9U-fNXX2DQmAW9u8ObRdpQjUiYz8SoJydjUPYdJl-ZENhRRVu-TehxURQzXwQvI8Q6e3XLQXAws0jYyJ6i-706qv9Vh84i~44-kRaOr1aoX64swxXXis5yCELISS9LXqnHL8AjwLbcYxiNc-U-8Q__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29263 "
                      alt="29263-ALT"
                    />{" "}
                  </div>
                </div>

                <div className="paragraph-conta-21325 pos-abs">
                  <div className="stratus99-resea-29274 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/46b2/e7cf/42b084de11fbb90ed9ccda6072ea51bf?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=K9VVkcvYfo5cjjyBovEt44pK0hWAwYydRd68EUc6xMRIhuFRDs~h~Gq5qAixOGg5qX5-F6fjthbtWTbpDjBhdj2Ro~viJiyRn1wqmXudRAczdbv6g0CEzR5XR8tljYSaJZ8leyz~xcuD7fnSwvzrCVX5Bwqy1MVDPv64a3dIlNJpy~uqCqWixOnpLyidqPYdzaZItKaJnfuUAB5o~mXSN4thCpidAASwB0Hy46lebfxt6b~RYgppRPj-eZ~Wz2EbzhSAXlAyMpq8zNvZr67UNC5CvgB0Qqjlw-gz1F-vAUlZx4V2G~HI1YDMrK5jaWPNas9dD94Q1JZ~l5UtLdNU1A__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29274 "
                      alt="29274-ALT"
                    />{" "}
                  </div>

                  <div className="stratus99-resea-21327 pos-abs">
                    <span className="stratus99-resea-21327-0">{`03 111 666 144
0317 1777015.
`}</span>
                  </div>

                  <div className="alamat-29279 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/e630/04bc/e9db1205547078cb1692887515664c72?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=JU2K0CObeEsVHI6JHRZ8Y3JxBvtXddmyfZOsHnPdqehTr9uQuiaEKx23yVe7j6pkNvT8YH7tWkQ6h-PLcKjodoBJLTXLLRnHRRXadb0SuZXbAUKKj05SLBTZVh3Oi5~bFcD55WtHzly4sb5tIcZxRRnVBkLXAfhemjEWbM6bxCV0-rTomxRiwhBajNrYZQNFUZFDUO0uVjQffjCyo5AbhVOtj8ENxQPpY00j98IzSl9GV3hdAmkmaD~O0dwl8yNT~dIk9f4nlkHBqwK946G3UDc~dOUoNZnTBiP2MR40aZ14~XUeCrm86lxIAzux8TmMAyVXPPO1l03YaToviWIeRA__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29279 "
                      alt="29279-ALT"
                    />{" "}
                  </div>

                  <div className="golden-tower-lt-29281 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/7c0c/508d/b5f532ac0b2db7ab08792e1eebba9987?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=ATu3LGEIq11EdlCtxswvdQYHmwPSRw~gymYxKEQqJtmPFMYEdKiUCH6HOgX6E3JHKupP6z905A4ctkeus7JpFqi5z9tDMZjVxAEi1RRWMXO~jqPvH~PEsXykqfwC-CfyODcXu3am~wMOrtC6ZF0rdxuND1IzARQhwwfmHmCnUwIQJUEu1pKMuZQp9j0DFNLz9OWiGOcrFH5VT2srT5eQt-0ZHLCqLiI2~p83cYmPAmAAPsjyuRjGk9J8L3RMECegjiVkkdRT9WqayoIHSvNqqpK4x~MlEGC-NpDgiNMPeAtaWvzP1Cxe40NIBFEM7NSWCYcJNRuCJWrbTRKILxVTzg__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29281 "
                      alt="29281-ALT"
                    />{" "}
                  </div>
                </div>
              ...
              <div className="frame-100000462-21330 pos-abs">
                <div className="frame-100000462-21331 pos-abs">
                  <div className="customer-care-21332 pos-abs">
                    <span className="customer-care-21332-0">{`Customer Care`}</span>
                  </div>

                  <div className="frame-100000462-21333 pos-abs">
                    <div className="my-account-290100 pos-abs">
                      <img
                        src="https://s3-alpha-sig.figma.com/img/58be/8383/9e3f6e96d20668021f0347370efe9434?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=TQPhyJ8msXfhkbTXoEwhMG0e2nJIIBlzWjabmDuENuUOiILkWFSGrLSG~YvmGIjHNnvoXxrTGeqssGGXk~Ug1W9YgKWNScmeUY-QNtXh9efL~zZaqyW-Z8UjScupcqqV-GjhR4s77t-XY8xjeRcR457jJwR-melAILgVGnR1VTM6beO93ZBlbStZN0k62XCWFJLXG3jCcmAAK2gKFIMgF9cFZTBA7gJjEcNfxERVIMuJCU-zfWYetmtTyIEA2leE-89QON2v7SBalwxWHVDArqsKZD7jbmZsIsBx~0lcbgxMQ~OctGz-2r14YMW5SeWcEBf8j3DjCzQ8ic-KbzXHxQ__"
                        className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-290100 "
                        alt="290100-ALT"
                      />{" "}
                    </div>

                    <div className="track-your-orde-21335 pos-abs">
                      <span className="track-your-orde-21335-0">{`Track Your Order
`}</span>
                    </div>

                    <div className="recently-viewed-21336 pos-abs">
                      <span className="recently-viewed-21336-0">{`Recently Viewed
`}</span>
                    </div>

                    <div className="wishlist-21337 pos-abs">
                      <span className="wishlist-21337-0">{`Wishlist

`}</span>
                    </div>

                    <div className="compare-21338 pos-abs">
                      <span className="compare-21338-0">{`Compare

`}</span>
                    </div>

                    <div className="become-a-vendor-21339 pos-abs">
                      <span className="become-a-vendor-21339-0">{`Become a Vendor`}</span>
                    </div>
                  </div>
                </div>

                <div className="frame-100000462-21340 pos-abs">
                  <div className="ikuti-kami-21341 pos-abs">
                    <span className="ikuti-kami-21341-0">{`Ikuti Kami`}</span>
                  </div>

                  <div className="vertical-contai-29082 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/bd4e/350f/1f860f0f739578676a423df641e7a401?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=djhIgcuOmlfFcBVDjC8HQpZuUbLwBw~ncmgv5jgTOB1y3WFUmhLZU6lnjMXVAZaIHswINfgi8yxCfS6MJ6iApLFz7x4wopktw0zFUBiHG0OPLBAgIlSBIuCrmZSC5BCqyVWwc~XFTGPI07Bh8WbxKeWqdMhjPXkJBuDlsm8O1HIAooCRRaIj0FykHeCk5yH5fmTsrl2~SZfhZKNVywBBvd7DCGljJCHMqzDKfkJuc6JPKFOyB0Ez-aFyW9rZggjr58VtZls-d8bZ1GzxTothAlQvpn5~57dW5lJiJU84QR66IZOZVhPeQBv44o5RX~j96w2SAj~nURnS1hhyw3KzRA__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29082 "
                      alt="29082-ALT"
                    />{" "}
                  </div>

                  <div className="button-1-29085 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/50bf/8054/a400868ab7dca81c6feacc5ef6df265f?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=sCVjKSVizOxS5IMLAU7NkGW965RCzI0rQGguySHL71wGEY3ufzP2aZBDrI5B4elr~NP-kyAvd36nCdxRh3VqA2AzGJxu13TjVSWdFF2a4Ejwl0il67yeb73fOVGSJmQ7hW6k5zsJmht6aVQEx7TneK3vz46WzV~RvLUGm4sUwH9quGCVed~OU7amT3V2OXDDv9m5v7~2C~P3MUT74vUH2N~k2hcDStP7R8THV-eyR5VU7~cbfDrSjrwENmxLtjK5uhK-~OM~hBmeUy8O46IxEdiSaA3q8FUQUPjMqp8oRqGVFDuTYfrVn1fXNw45~xKCJnsCewTxXW9hCsJhBSXmlA__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29085 "
                      alt="29085-ALT"
                    />{" "}
                  </div>

                  <div className="vectorrr-1-29091 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/c4c3/7b2f/9d3c1a3f94c99e90bf0813cae5878266?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Jezr5QrEdV9iAiYj~bv1dVE3z9b3thMB1ue81MZiGvu3jLOzDzLyla5jwkZTRumraVRlrK0rj10T609OQGjlv0~H71e0K-J8nFimSP9ZLzryvLoX-RoHpNyHaw7YdKUl~4uBYDwaEDSdriekgA4H5S15VxzxxLh5ZhAevb8DLhh8q4EB~JAR8thz9vVTsLw-B49qABg4RTuUP8hCqEM12e-d7jrXh2Gxxh7nzmg4SrCkfkZIlUjoyS~iyYTOhrlm~D4lzEcSJzFZ2u0QjHbjvVRi4lmnY1ktB82kCRkr6iXAMNFehuXdeCLqodBpoQde81H8B2ZtnqktE1w2JM3asQ__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29091 "
                      alt="29091-ALT"
                    />{" "}
                  </div>

                  <div className="vector-1-29077 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/ede9/8c2f/15fd2931adf5c7519027c52bc1e4563d?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=cZ-tm-vtJfI~k-XOgveXu6dC7oJO81SMbMG-z5NW~DEQBVlwhpPQuC1CEXFxR5q2rUsIluvtLxIZcdHAW280joDBrx4qrUB36FLpr1mwqfgUYTUtNoB3U5~SJLt-LWPSr4MHXxrXtLoSVXDoHQ63u3QINIorCE8l55UXfdSjhTlvIoyHwEF6gh8So7oAL9st6AmkJJ8sir78cZ6MoEIZLoZTi7irt6bFf752Vjxy6DcVxEe6nin0UJc6GXeX9eeHBbo-kTCQ-mJ4uZpfrK05FdgAjhDeiSkV-J2DbDeO0Qnkj7diaBGI7sgNJ9Hne1v2EloY7-YomCMdudqQz9-k~w__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29077 "
                      alt="29077-ALT"
                    />{" "}
                  </div>

                  <div className="vectorr-1-29088 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/0556/bbc6/b9beb6f43c54f9fb6ec43d4f359d3323?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=FV2uyO8aedv5hFXlouEA2IVklNzb0DYk9jtznDOc7yzjd5H60ek3TUPE7tUYF13LhlY7m4oI7i5ZiClE3qbkxIDmu6BRYiCMMX6QUK3O2NykxxYQiwTaV1BSMGHeY7mryKOq1VEg7Vz1OsiATpdOBLz5g2DTztDm~7id8XVwSgL4SstoQtVw3KvOcB9drfAIiOvxjv7lnxXAhinn1OgDuYZCQ5l7czwmCR~-EuvWsdKEAyc-7rnZpNVtxInJ3jrD3cCFi1FPuamcfrgvTHNhEgaJM7Jdswxl-GmIKQhbKgCJ8Pbiyny7UvplpX60ZGfJiZOgcSnUJR8HjNxmRhvYVQ__"
                      className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-29088 "
                      alt="29088-ALT"
                    />{" "}
                  </div>

                  <div className="download-aplika-21352 pos-abs">
                    <span className="download-aplika-21352-0">{`Download Aplikasi Kami`}</span>
                  </div>

                  <div className="image-21354 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/9a4b/e58b/f7c66fad09ccf9856ff979cf2641c8b9?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=fygHf-7rMlbbN~-T4cFfWgt-eHOQR0aNdW-y60Oj8Ye4MkbuWgHIXEXD-7ZFHa0vUV0qhP1PHUxwlr-MZy9hX0iNYcik2uXhhb2nVbU~boq1e3xnP3gfGwBC4XVXjY83pyvbVa7tcS5WipXhoXC-qVKe4M8VU7v8n8QmO8CPrxi09U5sMYoi8JyV-VoDeUcWnLV9IbAJqTPg8H8RkED1DafK90vo~GKpAZf170la8l1TBfLiw9BHOhjS2xtV1W9-I6zjpDwZiNDJpfC5a5ig-uYHhHKnwAzBQat5vwvgkRqpcs34ZjiChff1nJvyfZEUeM0Z8sd5~eG9cb1RPdcqVA__"
                      className="pos-abs image-div bg-no-repeat bg-crop nodeBg-21354 "
                      alt="21354-ALT"
                    />{" "}
                  </div>

                  <div className="image-21355 pos-abs">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/9a4b/e58b/f7c66fad09ccf9856ff979cf2641c8b9?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=fygHf-7rMlbbN~-T4cFfWgt-eHOQR0aNdW-y60Oj8Ye4MkbuWgHIXEXD-7ZFHa0vUV0qhP1PHUxwlr-MZy9hX0iNYcik2uXhhb2nVbU~boq1e3xnP3gfGwBC4XVXjY83pyvbVa7tcS5WipXhoXC-qVKe4M8VU7v8n8QmO8CPrxi09U5sMYoi8JyV-VoDeUcWnLV9IbAJqTPg8H8RkED1DafK90vo~GKpAZf170la8l1TBfLiw9BHOhjS2xtV1W9-I6zjpDwZiNDJpfC5a5ig-uYHhHKnwAzBQat5vwvgkRqpcs34ZjiChff1nJvyfZEUeM0Z8sd5~eG9cb1RPdcqVA__"
        ...
        {/* Frame 100000462425 */}
        <section className="frame-100000462-21356 pos-abs">
          <div className="c-2021-stratus99--290103 pos-abs">
            <img
              src="https://s3-alpha-sig.figma.com/img/8c1b/7286/ab20180f31289b9b5056b5c12b084ee8?Expires=1750636800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=nH878tkGi1WjLNRB1f1c9B4tc1tqgZoobK954Qgu2On-yWg9tAGblDJtGyPZixJPSh26~1uusACDdO3qdftRE0wVQdqMVRrhhs0MPE~FSKgoljF7GPWjbm0w5gldf7bx1QBrtHI8-30SZauoUCJ4MZLk7hxMoF~qKoesHRIroNmOK04eJw14p1lOzPsD2cpFKqheqEnop2do0O02rRojTEhOtvFOjQQKErbcjviO568fZEYNcMwcPRYk7OlK1mXZWf31FwGfjUj3iJXk8y2OlADKDsMYCKLeK7GbkTeEvVeVagltxUjziz9udYAlhY~RtXXaBBvGvwaHKDbK3cnFew__"
              className="pos-abs image-div bg-no-repeat fill-parent bg-cover nodeBg-290103 "
              alt="290103-ALT"
            />{" "}
          </div>
        </section>
